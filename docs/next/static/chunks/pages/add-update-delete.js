_N_E =
(window["webpackJsonp_N_E"] = window["webpackJsonp_N_E"] || []).push([["pages/add-update-delete"],{
...
/***/ "./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2Fadd-update-delete&absolutePagePath=E%3A%5Cstudy%5Creact-tree-renderer%5Cexamples%5Cbasic%5Cpages%5Cadd-update-delete.js!./":
/*!******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2Fadd-update-delete&absolutePagePath=E%3A%5Cstudy%5Creact-tree-renderer%5Cexamples%5Cbasic%5Cpages%5Cadd-update-delete.js ***!
  \******************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
    ...
    (window.__NEXT_P = window.__NEXT_P || []).push([
      "/add-update-delete",
      function () {
        return __webpack_require__(/*! ./pages/add-update-delete.js */ "./pages/add-update-delete.js");
      }
    ]);
...
/***/ "./node_modules/react-tree-renderer/dist/TreeContainer.js":
/*!****************************************************************!*\
  !*** ./node_modules/react-tree-renderer/dist/TreeContainer.js ***!
  \****************************************************************/
/*! no static exports found */
...
var TreeNode_1 = __importDefault(__webpack_require__(/*! ./TreeNode */ "./node_modules/react-tree-renderer/dist/TreeNode.js"));
var helper_1 = __webpack_require__(/*! ./helper */ "./node_modules/react-tree-renderer/dist/helper.js");
var TreeContainer = /** @class */ (function (_super) {
    __extends(TreeContainer, _super);
    function TreeContainer() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TreeContainer.prototype.render = function () {
        var _a = this.props, data = _a.data, Template = _a.Template, onTreeEvent = _a.onTreeEvent;
        return (react_1.default.createElement(TreeNode_1.default, { data: data, onUpdateData: this.onUpdateData.bind(this), onTreeEvent: onTreeEvent, Template: Template, onDelete: function () {
                console.log('trying to delete root node');
            }, onUpdateParent: function () {
                console.log('trying to update parent of root');
            } }));
    };
    TreeContainer.prototype.onUpdateData = function (path, node) {
        var _a = this.props, data = _a.data, onUpdateData = _a.onUpdateData;
        var result = helper_1.pathMerge(data, path, node);
        onUpdateData(result);
    };
...
/***/ "./node_modules/react-tree-renderer/dist/TreeNode.js":
/*!***********************************************************!*\
  !*** ./node_modules/react-tree-renderer/dist/TreeNode.js ***!
  \***********************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var react_1 = __importStar(__webpack_require__(/*! react */ "./node_modules/react/index.js"));
var children_1 = __importDefault(__webpack_require__(/*! ./children */ "./node_modules/react-tree-renderer/dist/children.js"));
var TreeNode = /** @class */ (function (_super) {
    ...
    TreeNode.prototype.render = function () {
        var _this = this;
        var _a = this.props, _b = _a.data, data = _b === void 0 ? {} : _b, path = _a.path, onUpdateData = _a.onUpdateData, onTreeEvent = _a.onTreeEvent, Template = _a.Template, i = _a.i, onDelete = _a.onDelete, onUpdateParent = _a.onUpdateParent;
        var updateMyData = (function (fn) {
            return _this.updateData(fn(_this.props.data));
        }).bind(this);
        var children = children_1.default({
            TreeNode: TreeNode,
            data: data,
            ...
            Template: Template,
            path: path,
            deleteChildAt: function (i) { return _this.updateData(__assign(__assign({}, data), { children: (data.children || []).filter(function (x, j) { return i !== j; }) })); },
            updateMyData: updateMyData,
        });
        return (react_1.default.createElement(Template, { data: data, i: i, updateData: this.updateData.bind(this), treeEvent: this.treeEvent.bind(this), updateParent: onUpdateParent, children: children, deleteMe: onDelete, addChildren: function (children) { return _this.updateData(__assign(__assign({}, data), { children: (data.children || []).concat(children) })); }, isRoot: i === undefined }));
    };
    TreeNode.prototype.updateData = function (node) {
        var _a = this.props, path = _a.path, onUpdateData = _a.onUpdateData;
        onUpdateData(path, node);
    };
    TreeNode.prototype.treeEvent = function (eventStr, obj) {
        var _a = this.props, path = _a.path, onTreeEvent = _a.onTreeEvent;
...
/***/ "./node_modules/react-tree-renderer/dist/children.js":
/*!***********************************************************!*\
  !*** ./node_modules/react-tree-renderer/dist/children.js ***!
  \***********************************************************/
/*! no static exports found */
...
exports.default = (function (_a) {
    var TreeNode = _a.TreeNode, _b = _a.data, data = _b === void 0 ? {} : _b, onUpdateData = _a.onUpdateData, onTreeEvent = _a.onTreeEvent, Template = _a.Template, _c = _a.path, path = _c === void 0 ? '' : _c, deleteChildAt = _a.deleteChildAt, updateMyData = _a.updateMyData;
    if (!data.children) {
        return [];
    }
    var pathPrifix = path ? path + "." : '';
    return data.children.map(function (data, i) {
        return (react_1.default.createElement(TreeNode, { data: data, onUpdateData: onUpdateData, onTreeEvent: onTreeEvent, onDelete: function () { return deleteChildAt(i); }, onUpdateParent: updateMyData, Template: Template, path: pathPrifix + "children." + i, i: i }));
    });
});
...
/***/ "./node_modules/react-tree-renderer/dist/helper.js":
/*!*********************************************************!*\
  !*** ./node_modules/react-tree-renderer/dist/helper.js ***!
  \*********************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.pathGet = exports.pathMerge = void 0;
function pathMerge(obj, pathStr, toMerge) {
    ...
    var tobj = __assign({}, obj);
    var lastBranch = pathArr.reduce(function (o, p) {
        !o[p] && (o[p] = {});
        if (Array.isArray(o[p])) {
            o[p] = __spreadArrays(o[p]);
            return o[p];
        }
        o[p] = __assign({}, o[p]);
        return o[p];
...
function pathGet(obj, pathStr) {
    if (!pathStr)
        return obj;
    var pathArr = pathStr.split('.');
    return pathArr.reduce(function (tmp, p) {
        if (tmp === null)
            return null;
        if (typeof tmp[p] === 'undefined')
            return null;
        return tmp[p];
    }, obj);
}
...
/***/ "./node_modules/react-tree-renderer/dist/index.js":
/*!********************************************************!*\
  !*** ./node_modules/react-tree-renderer/dist/index.js ***!
  \********************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var TreeContainer_1 = __importDefault(__webpack_require__(/*! ./TreeContainer */ "./node_modules/react-tree-renderer/dist/TreeContainer.js"));
__exportStar(__webpack_require__(/*! ./helper */ "./node_modules/react-tree-renderer/dist/helper.js"), exports);
exports.default = TreeContainer_1.default;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(module) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TestTree; });
/* harmony import */ var E_study_react_tree_renderer_examples_basic_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/defineProperty */ "./node_modules/@babel/runtime/helpers/esm/defineProperty.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var react_tree_renderer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react-tree-renderer */ "./node_modules/react-tree-renderer/dist/index.js");
/* harmony import */ var react_tree_renderer__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react_tree_renderer__WEBPACK_IMPORTED_MODULE_2__);

var _jsxFileName = "E:\\study\\react-tree-renderer\\examples\\basic\\pages\\add-update-delete.js";
var __jsx = react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement;

function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { Object(E_study_react_tree_renderer_examples_basic_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }




class DefaultTemplate extends react__WEBPACK_IMPORTED_MODULE_1___default.a.Component {
  render() {
    const {
      data = {},
      children = [],
    ...
    return __jsx("div", {
      ...
      value: data.title,
      onChange: e => updateData(_objectSpread(_objectSpread({}, data), {}, {
...
class TestTree extends react__WEBPACK_IMPORTED_MODULE_1___default.a.Component {
  ...
  render() {
    const {
      root = {}
    } = this.state; //pass onUpdateData to TreeRenderer to handle data change | 给TreeRenderer传递onUpdateData来处理数据变化

    return __jsx(react_tree_renderer__WEBPACK_IMPORTED_MODULE_2___default.a, {
      Template: DefaultTemplate,
      data: root,
      onUpdateData: root => this.setState({
        root
      }),
      __self: this,
      __source: {
